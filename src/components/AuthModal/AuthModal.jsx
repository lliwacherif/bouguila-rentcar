  ...
  return (
    <div className="am-panel am-panel--form">
      <div className="am-panel__inner">
        ...
        <form onSubmit={handleSubmit} className="am-form" noValidate>
          ...
          <div className="am-row-two">
            ...
            <div className="am-field">
              ...
              <input className="am-input" type="number" min="18" max="99" placeholder="25" value={form.age} onChange={set('age')} required />
            </div>
          </div>

          <div className="am-field">
            <label className="am-label">{t('auth.email', 'Email')}</label>
            <input className="am-input" type="email" placeholder="mohamed@example.com" value={form.email} onChange={set('email')} required autoComplete="email" />
          </div>
          ...
          <div className="am-field">
            ...
            <div className="am-input-wrap">
              ...
              <button type="button" className="am-eye" onClick={() => setShowPw(p => !p)} tabIndex={-1}>
                {showPw ? <FiEyeOff size={15} /> : <FiEye size={15} />}
              </button>
            </div>
          </div>

          <div className="am-checkbox-wrap">
        ...
        <SocialOAuthButtons loading={loading} />

        <p className="am-switch">
          {t('auth.hasAccount', 'Vous avez déjà un compte ?')}{' '}
          <button type="button" className="am-switch-link" onClick={onSwitch}>

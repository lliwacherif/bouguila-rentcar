...
export default function Guide() {
  ...
  const statusList = [
    ...
    },
    {
      ...
      text: t('guide.approvedText', 'Approuvée ! Apportez votre code #TCR-XXXXXX et l\'acompte requis en agence.'),
    },
    {
      key: 'confirmed',
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: t('guide.faq3A', 'Il vous suffit de vous présenter avec votre code de réservation (#TCR-XXXXXX), votre permis de conduire original (valide depuis plus de 2 ans) et une pièce d\'identité (ou passeport).'),
    },
    {

...
async function seed() {
  ...
  const parcsData = [
    { name: 'Parc Monastir - Aéroport Habib Bourguiba', city: 'Monastir', address: 'Aéroport International Habib Bourguiba, Monastir', capacity: 50, description: 'Agence principale Sahel & Monastir' },
